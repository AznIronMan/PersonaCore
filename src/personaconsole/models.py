...
class AdminPasswordChangePageConfig:
    ...
    current_password_label: str = ""
    current_password_name: str = "current_password"
    current_password_autocomplete: str = "current-password"
    current_password_min_length: int = 0
    current_password_max_length: int = 0
    current_password_pattern: str = ""
    current_password_inputmode: str = ""
    new_password_label: str = "New password"
    new_password_name: str = "new_password"
    new_password_autocomplete: str = "new-password"
    confirm_password_label: str = "Confirm password"
    confirm_password_name: str = "confirm_password"
    confirm_password_autocomplete: str = "new-password"
    method_label: str = "Password change"
    submit_label: str = "Change password"
    min_length: int = 0
    max_length: int = 0
    password_pattern: str = ""
    password_inputmode: str = ""
    disabled: bool = False
    status_message: str = ""
    status_tone: str = "bad"
    banners: Sequence[FlashBanner | Mapping[str, object] | str] = field(default_factory=tuple)
