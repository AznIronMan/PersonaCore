...
- Added `personaconsole.controls` as the public submodule import path.
- The renderer emits both PersonaConsole classes and legacy-compatible
...
PersonaConsole does not build status URLs, query runtime databases, decide which
...
PYTHONPATH=src python3 examples/fixture_app.py --output /tmp/personaconsole-fixture-1.0.15.html
